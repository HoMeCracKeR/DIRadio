    ...
    Partial Friend Class MyApplication
        ...
        Private Sub MyApplication_UnhandledException(sender As Object, e As Microsoft.VisualBasic.ApplicationServices.UnhandledExceptionEventArgs) Handles Me.UnhandledException
            ...
            ElseIf e.Exception.Message.ToLower.Contains("bass.net") Then
                MsgBox("There was an error loading the BASS.NET library. Please make sure that the Bass.Net.dll file is located in the same folder as the main executable, and that it is version number 2.4.10.2." & vbNewLine & vbNewLine & "You can do this by right-clicking the DLL file, clicking Properties, and finally the Details tab.", MsgBoxStyle.Critical)
            Else
