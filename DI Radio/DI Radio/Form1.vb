...
#Region "Update stuff"
    ...
    Public TotalVersionFixed As Integer = 18    ' -> For commodity, I don't use the actual version number of the application to know when there's an update. Instead I check if this number is higher.
